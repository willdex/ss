...
class Sistema_Integral extends Conexion
{
        ...
        public function preparar($codigo,$edad,$id_empresa,$id_galpon,$id_granja,$imagen1,$imagen2,$imagen3,$imagen4,$imagen5,$observaciones,$revision,$fecha,$nro_pollos,$sexo,$id_sqlite,$imei,$firma_invetsa,$firma_empresa,$id_tecnico,$imagen_jefe,$comentarios)
        {
                $this->codigo=$codigo;
                $this->edad=$edad;
        ...
        {
                $sql="INSERT into sistema_integral(codigo,edad,id_empresa,id_galpon,id_granja,observaciones,revision,fecha,nro_pollos,sexo,id_sqlite,imei,id_tecnico,comentarios)values('$this->codigo','$this->edad','$this->id_empresa','$this->id_galpon','$this->id_granja','$this->observaciones','$this->revision','$this->fecha','$this->nro_pollos','$this->sexo','$this->id_sqlite','$this->imei','$this->id_tecnico','$this->comentarios')";
